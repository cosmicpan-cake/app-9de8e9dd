      ...
      <div class="settings-card">
        ...
        <div class="field-row stacked">
          ...
          <div class="input-group">
            <button type="button" class="sign-toggle" data-for="inChange" aria-label="Artı / eksi">+</button>
            <input class="field-input" type="text" inputmode="decimal" id="inChange" placeholder="4,12">
          </div>
        </div>
        <p class="field-hint">Hissenin günlük fiyat değişimi %'si. Düşüş için soldaki
